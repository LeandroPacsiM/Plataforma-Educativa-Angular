...
@Component({
  ...
  styles: [`
    ...
    .back-btn { font-size: 0.875rem; font-weight: 500; color: var(--fg-muted); cursor: pointer; background: none; border: none; padding: 0.25rem 0; transition: color 0.2s; }
  ...
  template: `
    <div class="header">
      <div class="header-inner">
        ...
        <button class="back-btn" (click)="goTo('/dashboard')">&larr; Volver al dashboard</button>
      </div>
    </div>
    <div class="tabs">
      <div class="tabs-inner">
        <a class="tab" routerLink="/admin/users" routerLinkActive="active" [routerLinkActiveOptions]="{exact:true}">Usuarios</a>
      </div>
    </div>
    <div class="content">
      <router-outlet />
